...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextSelectsize = ta.getDimension(R.styleable.SlidingTabLayout_tl_textSelectsize, -1);
        if (mTextSelectsize == -1) {
    ...
    private void addTab(final int position, String title, View tabView) {
        ...
        ImageView ivVip = (ImageView) tabView.findViewById(R.id.iv_vip);
        boolean isVip = "mainVip".equals(title);
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
            ...
            if (tv_tab_title != null) {
                ...
                if (isDraw) {
//                    if (tv_tab_title.getText().toString().length()*18)
                    MarginLayoutParams lp = (MarginLayoutParams) ivVip.getLayoutParams();
                    lp.width = dp2px(tv_tab_title.getText().toString().length() * 20);
                    ivVip.setLayoutParams(lp);
                    ivVip.setBackgroundResource(i == mCurrentTab ? R.drawable.tab_changed_bg : R.drawable.tab_change_bg);
                    ivVip.setVisibility(VISIBLE);
                    tv_tab_title.setPadding((int) mTabPadding + dp2px(10), 0, (int) mTabPadding + dp2px(10), 0);
                } else {
    ...
    public void drawStyle(boolean drawStyle) {
        isDraw = drawStyle;
    }
    ...
    public void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            if (tab_title != null) {
                ...
                if (isDraw) {
//                    if (tv_tab_title.getText().toString().length()*18)
                    ivVip.setBackgroundResource(isSelect ? R.drawable.tab_changed_bg : R.drawable.tab_change_bg);
                    ivVip.setVisibility(VISIBLE);
                } else {
                    ivVip.setVisibility(GONE);
                }
