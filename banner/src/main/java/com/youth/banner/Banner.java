...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    public Banner setImageLoader(ImageLoaderInterface imageLoader, int type) {
    ...
    public Banner setImages(List<?> imageUrls, String code) {
...
//            }
            ...
            layoutParams.leftMargin = Math.abs(pageMargin);
