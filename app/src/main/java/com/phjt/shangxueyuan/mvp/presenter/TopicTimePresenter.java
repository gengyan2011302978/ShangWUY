 ...
 */
@FragmentScope
public class TopicTimePresenter extends BasePresenter<TopicTimeContract.Model, TopicTimeContract.View> {
    ...
    @Inject
    public TopicTimePresenter(TopicTimeContract.Model model, TopicTimeContract.View rootView) {
