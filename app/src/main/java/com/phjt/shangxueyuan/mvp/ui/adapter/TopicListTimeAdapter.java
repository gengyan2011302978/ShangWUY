 ...
 * description: 描述
 */
public class TopicListTimeAdapter extends BaseQuickAdapter<TopicListBean.RecordsBean, BaseViewHolder> {

    public TopicListTimeAdapter(@Nullable List<TopicListBean.RecordsBean> data) {
