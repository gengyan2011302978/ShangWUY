 ...
 * description:
 */
public class AnswerImagetAdapter extends BaseQuickAdapter<ExerciseShowBean.RecordVosBean, BaseViewHolder> {
    private Context mContext;
    public AnswerImagetAdapter(Context context, List<ExerciseShowBean.RecordVosBean> date) {
    ...
    protected void convert(BaseViewHolder helper, ExerciseShowBean.RecordVosBean item) {
        ...
        if ("0".equals(String.valueOf(item.getQuestionType())) || "null".equals(String.valueOf(item.getQuestionType())) ||item.getQuestionType() == 5) {
