 ...
 * description: 描述
 */
public class HompageInformationAdapter extends BaseQuickAdapter<PopularArticleListBean, BaseViewHolder> {

    public HompageInformationAdapter(@Nullable List<PopularArticleListBean> data) {
        super(R.layout.item_homepage_imformation, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, PopularArticleListBean item) {
        ...
        tvNumber.setText(Utils.numberFix(item.getArticleNum())+"人在看");
    }
}
