...
public class MyTimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private MyTimePickerView.OnTimeSelectListener timeSelectListener;//回调接口
    ...
    //构造方法
    public MyTimePickerView(MyTimePickerView.Builder builder) {
    ...
    public static class Builder {
        private int layoutRes = R.layout.dialog_pickerview_options;
        private CustomListener customListener;
        private Context context;
        private MyTimePickerView.OnTimeSelectListener timeSelectListener;
        ...
        //Required
        public Builder(Context context, MyTimePickerView.OnTimeSelectListener listener) {
            this.context = context;
            this.timeSelectListener = listener;
        }

        //Option
        public MyTimePickerView.Builder setType(boolean[] type) {
            this.type = type;
            return this;
        }

        public MyTimePickerView.Builder gravity(int gravity) {
            this.gravity = gravity;
            return this;
        }

        public MyTimePickerView.Builder setSubmitText(String Str_Submit) {
            this.Str_Submit = Str_Submit;
            return this;
        }

        public MyTimePickerView.Builder isDialog(boolean isDialog) {
            this.isDialog = isDialog;
            return this;
        }

        public MyTimePickerView.Builder setCancelText(String Str_Cancel) {
            this.Str_Cancel = Str_Cancel;
            return this;
        }

        public MyTimePickerView.Builder setTitleText(String Str_Title) {
            this.Str_Title = Str_Title;
            return this;
        }

        public MyTimePickerView.Builder setSubmitColor(int Color_Submit) {
            this.Color_Submit = Color_Submit;
            return this;
        }

        public MyTimePickerView.Builder setCancelColor(int Color_Cancel) {
         ...
         * @return
         */
        public MyTimePickerView.Builder setDecorView(ViewGroup decorView) {
            this.decorView = decorView;
            return this;
        }

        public MyTimePickerView.Builder setBgColor(int Color_Background_Wheel) {
            this.Color_Background_Wheel = Color_Background_Wheel;
            return this;
        }

        public MyTimePickerView.Builder setTitleBgColor(int Color_Background_Title) {
            this.Color_Background_Title = Color_Background_Title;
            return this;
        }

        public MyTimePickerView.Builder setTitleColor(int Color_Title) {
            this.Color_Title = Color_Title;
            return this;
        }

        public MyTimePickerView.Builder setSubCalSize(int Size_Submit_Cancel) {
            this.Size_Submit_Cancel = Size_Submit_Cancel;
            return this;
        }

        public MyTimePickerView.Builder setTitleSize(int Size_Title) {
            this.Size_Title = Size_Title;
            return this;
        }

        public MyTimePickerView.Builder setContentSize(int Size_Content) {
         ...
         * @return
         */
        public MyTimePickerView.Builder setDate(Calendar date) {
            this.date = date;
            return this;
        }

        public MyTimePickerView.Builder setLayoutRes(int res, CustomListener customListener) {
            this.layoutRes = res;
            this.customListener = customListener;
            return this;
        }

        public MyTimePickerView.Builder setRange(int startYear, int endYear) {
        ...
        public MyTimePickerView.Builder setRangDate(Calendar startDate, Calendar endDate) {
         ...
         */
        public MyTimePickerView.Builder setLineSpacingMultiplier(float lineSpacingMultiplier) {
         ...
         * @param dividerColor
         */
        public MyTimePickerView.Builder setDividerColor(int dividerColor) {
         ...
         * @param dividerType
         */
        public MyTimePickerView.Builder setDividerType(WheelView.DividerType dividerType) {
        ...
        public MyTimePickerView.Builder setBackgroundId(int backgroundId) {
         ...
         */
        public MyTimePickerView.Builder setTextColorCenter(int textColorCenter) {
         ...
         * @param textColorOut
         */
        public MyTimePickerView.Builder setTextColorOut(int textColorOut) {
            this.textColorOut = textColorOut;
            return this;
        }

        public MyTimePickerView.Builder isCyclic(boolean cyclic) {
            this.cyclic = cyclic;
            return this;
        }

        public MyTimePickerView.Builder setOutSideCancelable(boolean cancelable) {
            this.cancelable = cancelable;
            return this;
        }

        public MyTimePickerView.Builder setLabel(String label_year, String label_month, String label_day, String label_hours, String label_mins, String label_seconds) {
        ...
        public MyTimePickerView.Builder isCenterLabel(boolean isCenterLabel) {
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            LayoutInflater.from(context).inflate(R.layout.dialog_pickerview_options, contentContainer);
            ...
            //设置文字
            btnSubmit.setText(TextUtils.isEmpty(Str_Submit) ? context.getResources().getString(R.string.string_submit) : Str_Submit);
            btnCancel.setText(TextUtils.isEmpty(Str_Cancel) ? context.getResources().getString(R.string.string_cancel) : Str_Cancel);
            tvTitle.setText(TextUtils.isEmpty(Str_Title) ? "选择时间" : Str_Title);//默认为空
