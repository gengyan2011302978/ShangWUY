...
public class SlideButton extends View {
    ...
    //圆形边框checked填充颜色
    private String CircleCloseCheckedColor = "#CCCCCC";
     ...
     * @param closeSolidColor      圆角矩形未被选中的颜色
     */
    public void setSmallCircleModel(int strokeLineColor, int strokeSolidColor, int circleCheckedColor, int circleNoCheckedColor,int closeSolidColor) {
        isBigCircle = false;
        ...
        mCloseSolidColor = closeSolidColor;
        invalidate();
    }
    ...
    public void setBigCircleModel(int strokeLineColor, int strokeCheckedSolidColor,
                                  ...
                                  int circleNoCheckColor,int closeSolidColor) {
        isBigCircle = true;
        strokeLineColor_int = strokeLineColor;
    ...
    private void init(Context context) {
        ...
        mCloseSolidColor = Color.parseColor(CircleCloseCheckedColor);
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        //外部圆角矩形的半径
        strokeCircleRadius = strokeHeight / 2+5;
        centerY = mHeight /2;
        //内部圆的半径
        if (isBigCircle) {
...
//        Log.i("TAG", "mHeight:" + mHeight + "   strokeCircleRadius: " + strokeCircleRadius);
        //内部圆的x轴起始坐标
        circleStartX = PADDING + strokeCircleRadius-8;
        //内部圆的x轴终点坐标
    ...
    private void drawRect(Canvas canvas) {
        ...
        if (isBigCircle && isChecked) {
            ...
            mPaint.setColor(mCloseSolidColor);
        }
        //画填充
