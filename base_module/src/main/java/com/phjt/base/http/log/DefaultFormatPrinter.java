 ...
 */
package com.phjt.base.http.log;

import android.text.TextUtils;


import com.phjt.base.utils.CharacterHandler;
...
public class DefaultFormatPrinter implements FormatPrinter {
  ...
  public void printJsonResponse(long chainMs, boolean isSuccessful, int code,
      @NonNull String headers, @Nullable
   ...
   */
  @Override
  public void printFileResponse(long chainMs, boolean isSuccessful, int code,
