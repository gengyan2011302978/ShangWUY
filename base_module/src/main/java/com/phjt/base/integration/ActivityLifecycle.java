...
import com.phjt.base.base.delegate.ActivityDelegate;
import com.phjt.base.base.delegate.ActivityDelegateImpl;
...
public class ActivityLifecycle implements Application.ActivityLifecycleCallbacks {
  ...
  @Override public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
    ...
    if (activity instanceof IActivity) {
      ...
      if (activityDelegate == null) {
        ...
        cache.put(IntelligentCache.getKeyOfKeep(ActivityDelegate.ACTIVITY_DELEGATE),
            activityDelegate);
      }
  ...
  private void registerFragmentCallbacks(Activity activity) {
    boolean useFragment =
        activity instanceof IActivity ? ((IActivity) activity).useFragment() : true;
    if (activity instanceof FragmentActivity && useFragment) {
      ...
      if (mExtras.containsKey(IntelligentCache.getKeyOfKeep(ConfigModule.class.getName()))) {
        ...
        List<ConfigModule> modules = (List<ConfigModule>) mExtras.get(
            IntelligentCache.getKeyOfKeep(ConfigModule.class.getName()));
  ...
  private ActivityDelegate fetchActivityDelegate(Activity activity) {
    ...
    if (activity instanceof IActivity) {
      Cache<String, Object> cache = getCacheFromActivity((IActivity) activity);
      activityDelegate = (ActivityDelegate) cache.get(
