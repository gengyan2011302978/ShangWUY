...
public abstract class BaseView extends View implements View.OnClickListener, View.OnLongClickListener {
     ...
     * 选中月份农历文本颜色
     */
    protected Paint mCurMonthLunarTextPaintT = new Paint();
    /**
     * 当前月份农历文本颜色
     */
    ...
    protected Paint mSelectedPaint1 = new Paint();
    ...
    private void initPaint(Context context) {
        ...
        mCurMonthLunarTextPaintT.setAntiAlias(true);
        mCurMonthLunarTextPaintT.setTextAlign(Paint.Align.CENTER);
        ...
        mSelectedPaint1.setAntiAlias(true);
        mSelectedPaint1.setStyle(Paint.Style.FILL);
    ...
    final void updateStyle() {
        ...
        this.mCurMonthLunarTextPaintT.setColor(0xffffffff);
        ...
        this.mCurMonthLunarTextPaintT.setTextSize(mDelegate.getLunarTextSize());
        ...
        this.mSelectedPaint.setColor(0xff2675fe);
        this.mSelectedPaint1.setStyle(Paint.Style.FILL);
        this.mSelectedPaint1.setColor(0xfff3e9da);
    }
