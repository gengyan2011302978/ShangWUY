...
final class CalendarViewDelegate {
    ...
    CalendarViewDelegate(Context context, @Nullable AttributeSet attrs) {
        ...
        mCurDayTextColor = array.getColor(R.styleable.CalendarView_current_day_text_color, Color.BLUE);
        ...
        mCurMonthLunarTextColor = array.getColor(R.styleable.CalendarView_current_month_lunar_text_color, 0xffff8279);
